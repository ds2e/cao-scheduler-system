...
export default function ReservationPage({ reservations }) {
    ...
    return (
        ...
        //         <div className='w-full flex flex-col xs:flex-row items-center justify-between px-2 sm:px-6'>
        ...
        //                 Insgesamt: <span className="font-semibold text-3xl">{todayReservations.length}</span>
        //             </h2>
        //         </div>
        //     </div>
        //     <div
        ...
        //     </div>
        // </>
        <div className="flex items-center justify-center w-full h-screen pt-16">
            <h1>Diese Funktion befindet sich im Aufbau</h1>
        </div>
    );
}