...
export default function MainWebNavbar() {
    const { url } = usePage();
                    ...
                    <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
...

                        {
                            url === '/login' ?
                                <></>
                                :
                                <Link href={route('login')} className="cursor-pointer flex w-full justify-center rounded-md bg-theme-secondary ml-3 px-3 py-1.5 text-sm/6 font-semibold text-white shadow-xs hover:bg-theme-secondary-highlight focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
                                    Login
                                </Link>
                        }
                    </div>
