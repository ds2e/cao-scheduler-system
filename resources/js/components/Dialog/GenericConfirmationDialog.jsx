        ...
        <Dialog open={isOpen} onOpenChange={setOpen}>
            <DialogContent>
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Bestätigen Sie dieser Aktion, damit es nicht als ein Fehlklick interpretiert werden.
                    </DialogDescription>
                </DialogHeader>
                <div className="flex items-center justify-end gap-2">
                    <button type="button" onClick={() => confirmAction()} className="cursor-pointer px-4 py-2 text-white bg-theme rounded-full hover:bg-theme-highlight">Confirm</button>
